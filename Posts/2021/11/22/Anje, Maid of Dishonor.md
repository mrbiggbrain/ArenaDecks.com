...
Anje is all about sucking the life out of your opponent, a slow bleeding style of deck that looks to capatalise on blood tokens to drain the opponent out while keeping your life total high. 

## Vampires

Anje cares about vampires, so we care about vampires as well. 24 vampires call this deck their home, and each one ensures we stay agressive and dedicaed to our plan. 
...
We also run several cards to support our vampires in their quest. These cards help us keep our hands full and our threats attacking in. 
...
Blood tokens are a core part of our deck. Sure we can use them to filter our cards and find what we need, but we can also use them for other things as well. 
...
1 Mayhem Devil (WAR) 204
1 Gluttonous Guest (VOW) 114
1 Olivia's Attendants (VOW) 1721 Ceremonial Knife (VOW) 254
1 Inspiring Statuary (AER) 160
1 Mayhem Devil (WAR) 204
1 Gluttonous Guest (VOW) 114
1 Olivia's Attendants (VOW) 172
...
We are going to gain alot of life as we slowly drain away our opponents life force. It's bast to use this to our advantage. We run a number of ways to gain additional value from our commander. 
...
The majority of our card draw package is sacrifice based, with a minor life theme thrown in. 
...
We are heavily based around creature removal, with some light artifact removal tossed in. 
...
Our multi-target package includes creature based board wipes, and a flexible answer to various cards. 
...
For the most part we are running a standard artifact based ramp package, but we also run Statuary as a huge accelerant for the late game, often letting us power out our commander over and over. 
...
Our land package is a pretty standard two color Rakdos manabase. We start with a collection of dual lands. 
...
We run some any color lands. Specifically in this deck we can run unclaimed territory and Voldaren Estate, which doubles as a source of blood tokens later in the game
...
We run the standard 3 fetch lands to search out basics. 
...
Some utility lands to pull double duty. 
...
And finish off the manabase with some Snow Basics. 
